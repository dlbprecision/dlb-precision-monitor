...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\Build-Installer.ps1 -Version 0.1.3 -OutputDirectory .\artifacts\unsigned-0.1.3-attempt-1
```
